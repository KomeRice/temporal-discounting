...
function Game() {
    ...
    if (formsList.includes("Square")) {
        learningForms.push(new Square(getLearningGridX(), getLearningGridY(formsList.indexOf("Square")), LC_CELL, false, ctxLearning));
    }
    if (formsList.includes("Circle")) {
        learningForms.push(new Circle(getLearningGridX(), getLearningGridY(formsList.indexOf("Circle")), LC_CELL, false, ctxLearning));
    }
    if (formsList.includes("Triangle")) {
        learningForms.push(new Triangle(getLearningGridX(), getLearningGridY(formsList.indexOf("Triangle")), LC_CELL, false, ctxLearning));
    }
    if (formsList.includes("Cross")) {
        learningForms.push(new Cross(getLearningGridX(), getLearningGridY(formsList.indexOf("Cross")), LC_CELL, false, ctxLearning));
    }
